...
public:
    ...
    {
        customDia->setWindowTitle(QApplication::translate("customDia", "Dialog", Q_NULLPTR));
        diaBtn->setText(QApplication::translate("customDia", "Confirm", Q_NULLPTR));
        pushButton->setText(QApplication::translate("customDia", "Cancel", Q_NULLPTR));
    } // retranslateUi
